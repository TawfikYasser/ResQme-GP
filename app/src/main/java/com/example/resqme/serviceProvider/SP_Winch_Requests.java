...
public class SP_Winch_Requests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        winchRequestsAdapter = new SPWinchRequestsAdapter(winchRequests, this, CustomerDB);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot: snapshot.getChildren()){
                    ...
                    if(winchRequest.getWinchOwnerID().equals(sp_userid)){
                        ...
                        winchRequestsAdapter = new SPWinchRequestsAdapter(winchRequests, context, CustomerDB);
                        winchRequestRV.setAdapter(winchRequestsAdapter);
                    }
                }
            }
